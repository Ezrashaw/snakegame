...
objcopy -R .got.plt -R .comment target/x86_64-unknown-linux-musl/release/snake contrib/snake/snake
objcopy -R .got.plt -R .comment target/x86_64-unknown-linux-musl/release/snake-server contrib/snake/snake-server
